...
var (
	...
	grpcRacingEndpoint = flag.String("grpc-racing-endpoint", "localhost:9000", "gRPC server endpoint")
	grpcSportsEndpoint = flag.String("grpc-sports-endpoint", "localhost:9001", "gRPC server endpoint")
)
